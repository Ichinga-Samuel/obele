...
class Page:
	...
	def __repr__(self) -> str:
		"""Return a compact summary of the page position and item counts."""
...
class CursorPage:
	...
	def __repr__(self) -> str:
		"""Return a compact summary of the item count and navigation flags."""
...
def cursor_paginate_queryset(
		queryset: Any, *, per_page: int = 20, cursor_field: str = "", after: Any = None, before: Any = None
) -> CursorPage:
