...
class Database:
    ...
    @classmethod
    def configure(cls, db_path: str | None = None, pragmas: dict[str, Any] | None = None) -> None:
    ...
    @classmethod
    async def aconfigure(cls, db_path: str | None = None, pragmas: dict[str, Any] | None = None) -> None:
