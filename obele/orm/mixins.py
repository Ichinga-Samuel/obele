...
Compose with `Model` via multiple inheritance:
...
from .fields import BooleanField, DateTimeField
...
class TimestampMixin:
	...
	def save(self) -> None:
		"""Stamp `updated_at` (and `created_at` on insert), then save."""
		now = _utcnow()
...
class SoftDeleteMixin:
	...
	`delete` marks the row deleted instead of removing it; default
